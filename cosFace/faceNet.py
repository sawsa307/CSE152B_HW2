...
class faceNet(nn.Module):
    def __init__(self,classnum=10574, feature=False, m = 1.35):
        ...
        self.bn2_5 = nn.BatchNorm2d(num_features=128)
        ...
        self.bn3_5 = nn.BatchNorm2d(num_features=256)
        self.relu3_5 = nn.PReLU(256)

        self.conv3_6 = nn.Conv2d(256,256,3,1,1) #=>B*256*14*12
        self.bn3_6 = nn.BatchNorm2d(num_features=256)
        self.relu3_6 = nn.PReLU(256)
        self.conv3_7 = nn.Conv2d(256,256,3,1,1)
        self.bn3_7 = nn.BatchNorm2d(num_features=256)
        self.relu3_7 = nn.PReLU(256)

        self.conv3_8 = nn.Conv2d(256,256,3,1,1) #=>B*256*14*12
        self.bn3_8 = nn.BatchNorm2d(num_features=256)
        self.relu3_8 = nn.PReLU(256)
        self.conv3_9 = nn.Conv2d(256,256,3,1,1)
        self.bn3_9 = nn.BatchNorm2d(num_features=256)
        ...
        self.bn_fc5 = nn.BatchNorm1d(num_features=512)
